...
public class EspacioVerdeController {
	...
	@PostMapping
	public ResponseEntity<Object> crearEspacioVerde(@RequestBody String ubicacion) {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Object> eliminarEspacioVerde(@PathVariable(name = "id") Long id) {
		HttpStatus httpStatus = HttpStatus.BAD_REQUEST;
	...
	public ResponseEntity<List<EspacioVerdeDTO>> traerTodos() {
		return new ResponseEntity<List<EspacioVerdeDTO>>(espacioVerdeService.traerTodos(), HttpStatus.OK);
	}

	@GetMapping("/{id}")
	public ResponseEntity<EspacioVerdeDTO> traerConDependencias(@PathVariable(name = "id") Long id) {
	...
	@PostMapping("/{id}")
	public ResponseEntity<Object> agregarSensorAEspacioVerde(@PathVariable(name = "id") Long id,
