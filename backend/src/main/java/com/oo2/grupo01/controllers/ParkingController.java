...
public class ParkingController {
	...
	@PostMapping("/{id}")
	public ResponseEntity<Object> crearEstacionamiento(@PathVariable(name = "id") Long idParking,
			@RequestBody Integer numero) {
		HttpStatus httpStatus = HttpStatus.BAD_REQUEST;

		try {
			estacionamientoService.agregar(Lugares.ESTACIONAMIENTO, parkingService.traer(idParking), numero);
			httpStatus = HttpStatus.CREATED;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public ResponseEntity<List<ParkingDTO>> traerTodosLosParkings() {
		return new ResponseEntity<List<ParkingDTO>>(parkingService.traerTodos(), HttpStatus.OK);
	}

	@GetMapping("/{id}")
	public ResponseEntity<ParkingDTO> traerParking(@PathVariable(name = "id") Long id) {
	...
	public ResponseEntity<EstacionamientoDTO> traerEstacionamiento(
		...
		if (parkingService.traer(idParking) != null) {
			Estacionamiento estacionamiento = estacionamientoService.traerConDependencias(idEstacionamiento);
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Object> eliminarParking(@PathVariable(name = "id") Long id) {
		HttpStatus httpStatus = HttpStatus.BAD_REQUEST;
	...
	public ResponseEntity<Object> eliminarEstacionamiento(@PathVariable(name = "id") Long id,
	...
	public ResponseEntity<Object> agregarSensorAParking(@PathVariable(name = "idParking") Long id,
	...
	public ResponseEntity<Object> agregarSensorAEstacionamiento(@PathVariable(name = "idParking") Long idParking,
			@PathVariable(name = "idEstacionamiento") Long idEstacionamiento, @RequestBody Sensores tipo) {
		Estacionamiento estacionamiento = estacionamientoService.traer(idEstacionamiento);
		HttpStatus httpStatus = HttpStatus.BAD_REQUEST;
