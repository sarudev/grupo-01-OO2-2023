...
// @AllArgsConstructor
// public class EdificioController2 {
...
// @PostMapping("/{id}")
// public ResponseEntity<Object> crearEdificio(@PathVariable(name = "id") Long
// idEdificio,
...
// return new ResponseEntity<List<EdificioDTO>>(edificioService.traerTodos(),
// HttpStatus.OK);
// }

// @GetMapping("/{id}")
// public ResponseEntity<EdificioDTO> traerEdificio(@PathVariable(name = "id")
// Long id) {
...
// @DeleteMapping("/{id}")
// public ResponseEntity<Object> eliminarEdificio(@PathVariable(name = "id")
// Long id) {
// HttpStatus httpStatus = HttpStatus.BAD_REQUEST;
...
// public ResponseEntity<Object> eliminarAula(@PathVariable(name = "id") Long
// id,
...
// public ResponseEntity<Object> agregarSensorAEdificio(@PathVariable(name =
// "idEdificio") Long id,
...
// public ResponseEntity<Object> agregarSensorAAula(@PathVariable(name =
// "idEdificio") Long idEdificio,
